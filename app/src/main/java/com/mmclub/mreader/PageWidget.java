...
public class PageWidget extends View {
	...
	private static final String TAG = "ryj";
	...
	boolean mIsRTandLB; // is right-top and left-bottom
	...
	public void getPix(int width, int height){
		mWidth = width;
		mHeight = height;
	}
	...
	public PageWidget(Context context) {
		...
		mTouch.x = 0.01f; // avoid x, y being 0, or error when calculation
		mTouch.y = 0.01f;
	}

	/**
	 * Author : hmg25 Version: 1.0 Description : calculate touch point
	 */
	...
	/**
	 * Author : hmg25 Version: 1.0 Description : calculate intersection point of line p1p2 and p3p4
	 */
	...
	private void calcPoints() {
		...
		// when mBezierStart1.x < 0 || mBezierStart1.x > 480
		// BUG happens
		...
		/*
		 * mBeziervertex1.x decuction
		 * ((mBezierStart1.x+mBezierEnd1.x)/2+mBezierControl1.x)/2 equals to
	...
	/**
	 * Author : hmg25 Version: 1.0 Description : GradientDrawable for shade
	 */
	...
	public void drawCurrentPageShadow(Canvas canvas) {
		...
		// Log.i("ryj", "mBezierControl2.x   " + mBezierControl2.x
		// + "  mBezierControl2.y  " + mBezierControl2.y);
		mCurrentPageShadow.draw(canvas);
		canvas.restore();
	}
